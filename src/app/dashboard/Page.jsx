...
export default function Dashboard() {
      ...
      case "profile":
        return (
          <div className="flex items-center justify-center min-h-[80vh] bg-gray-50 dark:bg-gray-950">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 w-full max-w-md text-gray-900 dark:text-white">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h2 className="mt-4 text-2xl text-cyan-500 font-bold">
                  {user?.name}
                </h2>
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen bg-gray-100">
      ...
      <div className="hidden md:flex w-64 bg-gray-900 text-white p-4 flex-col gap-2 border-r border-gray-800">
      ...
      <div className="flex-1 p-4 md:p-6 overflow-y-auto pb-20 md:pb-6 bg-white dark:bg-gray-900 text-gray-900 dark:text-white">
        {renderContent()}
      </div>
