...
import { FaVenusMars, FaPaw, FaMapMarkerAlt } from "react-icons/fa";
import { MdHealthAndSafety } from "react-icons/md";

const AllPets = async () => {
    const res = await fetch("http://localhost:5000/pets?limit=6", {
        cache: "no-store",
    });
    ...
    return (
        ...
        <div className="max-w-7xl mx-auto px-4 py-10">
            ...
            <h3 className="text-2xl font-bold text-center mb-10"> 🐾 Find Your New Best Friend</h3>
